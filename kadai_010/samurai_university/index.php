          ...
          <!-- イベントここまで -->
           ...
           <div class="col-lg-6 col-md-6 col-sx-12 news_col">
            ...
            <div class="news_post_small">
              <div class="news_post_meta">
                <ul>
                  <li><a href="guaduates_detail.html">2022/05/02</a></li>
                </ul>
              </div>
              <div class="news_post_small_title">
                <a href="guaduates_detail.html">公開講座「UnityでつくるiOSアプリ」受講生募集</a>
              </div>
            </div>
            <div class="news_post_small">
              <div class="news_post_meta">
              ...
              <div class="news_post_small_title">
                <a href="guaduates_detail.html">新規カリキュラム「Pythonコース」登場!</a>
              </div>
            </div>
            <div class="news_post_small">
              <div class="news_post_meta">
